...
subsubsection \<open>Decomposition Rules Over ADD\<close>

theory ADD_decomposition
...
decomposing the \<open>ADD\<close> instruction. The three lemmas are the `special' case where we 
assume the guards of the instruction will pass.
